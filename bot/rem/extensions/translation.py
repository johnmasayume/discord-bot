        ...
        if message.channel.id == target_channel_id:
            ...
            if jp_chars or cn_chars:
                ...
                if jp_chars:
                    ...
                    original_chars = ''.join(jp_chars)
                if cn_chars:
                    translated_text += self.translator.translate(''.join(cn_chars), src='zh-CN', dest='en').text
                    original_chars = ''.join(cn_chars)

                await message.channel.send(f'Original: {original_chars}\nTranslated: {translated_text}')
